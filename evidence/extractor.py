...
def extract_evidence(observation: Observation, tracker: ResourceTracker | None = None, source_trace: str = "trace") -> Evidence:
    ...
    return Evidence(
        ...
        actor_id=observation.actor, actor_relation=relation, pre_state=dict(observation.state_before), post_state=dict(observation.state_after),
        ...
        response_features=dict(observation.features), source_trace=source_trace,
    )
